...
import { AlertTriangle, Users, CheckCircle, RefreshCw, Building2 } from "lucide-react"
...
export function EmergencyAccessModal({
  ...
  const handleSubmit = async () => {
    if (!reason.trim()) {
      setError("La raison de l'accès d'urgence est obligatoire")
      return
    }
    ...
    try {
      setError(null)
      const result = await setEmergencyAccess(reason.trim(), selectedUserIds)
      ...
      setError(err.message || "Erreur lors de l'activation de l'accès d'urgence")
    }
  }
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Accordez un accès d'urgence temporaire aux utilisateurs sélectionnés.
          </DialogDescription>
        </DialogHeader>
        ...
        {success ? (
          <div className="text-center py-6">
            ...
            <h3 className="text-lg font-semibold text-green-800 mb-2">
              Accès d'urgence activé !
            </h3>
            <p className="text-gray-600">
              Les utilisateurs sélectionnés ont maintenant un accès d'urgence au tenant.
            </p>
          </div>
        ) : (
          <div className="space-y-6">
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                <strong>Attention :</strong> Cette action accorde un accès d'urgence temporaire. 
                Utilisez cette fonctionnalité uniquement en cas d'urgence absolue.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-2">
              <Label htmlFor="reason">
                Raison de l'accès d'urgence *
              </Label>
              <Textarea
                id="reason"
                placeholder="Décrivez la raison de l'accès d'urgence..."
                value={reason}
            ...
            {selectedUserIds.length > 0 && (
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <p className="text-xs text-blue-600 mt-1">
                  Ces utilisateurs auront un accès d'urgence temporaire au tenant.
                </p>
              </div>
            )}
